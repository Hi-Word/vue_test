...
function getFenyeBottom(data,method,colspan){
	...
	lis.push('<option value="4">4</option><option value="8">8</option><option value="12">12</option><option selected="selected" value="16">16</option>');
	lis.push('<option value="32">32</option><option value="64">64</option><option value="88">88</option><option value="100">120</option>');
